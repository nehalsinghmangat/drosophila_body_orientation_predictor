...
│   └── figures/                # Figure panels generated by data_pipeline.ipynb and model_training.ipynb
├── utils/      
│   ├── utils.py
...
│   └── external/
├── models/                     
│   └── drosophila_body_orientation_predictor.keras  # Model written by model_training.ipynb  
└── requirements.txt
```
